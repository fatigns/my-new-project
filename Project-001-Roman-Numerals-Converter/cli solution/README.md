...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/fatigns/my-new-project/main/Project-001-Roman-Numerals-Converter"
wget ${FOLDER}/app.py
...
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name first-key-pair --security-group-ids sg-010d4684f6a610a7f --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
aws ec2 run-instances \
    ...
    --security-group-ids sg-010d4684f6a610a7f \ 
